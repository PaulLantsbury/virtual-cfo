...
export default function MarketingEfficiency() {
  ...
  return (
    <AppLayout>
       ...
       * How much contribution is generated by repeat customers versus newly
       * acquired customers — unlocked at Pro tier.
       *
      ...
      <div className="rounded-2xl border border-dashed border-border/60 p-6 mb-6 opacity-60">
        ...
        <p className="text-sm text-muted-foreground/70 leading-snug">
          How much contribution is generated by repeat customers versus newly acquired customers.
        </p>
      </div>
