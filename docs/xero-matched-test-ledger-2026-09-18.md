...
| Date | Shopify event | Xero entry | Expected separate-source treatment |
| --- | --- | --- |
| 5 Oct | Order: £100 product net, £20 VAT, £6 shipping net, £1.20 VAT; £127.20 customer cash | Sales invoice / settled payment for the same gross amount | Shopify trading revenue and Xero booked revenue remain separately labelled; VAT stays separate. |
...
2. Shopify £80 net product revenue and the mapped Xero booked revenue are shown as separate source values. Neither is added to the other, and no variance/difference is computed.
