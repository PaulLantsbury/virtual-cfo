...
Current checkpoint: `docs/session-handover-2026-09-17.md` and `docs/roadmap-2026-09-17.md`. Shopify restricted development intake, synthetic reporting verification, durable sales-sync history and signed-in status are applied and verified. Do not reapply their schemas/membership or repeat the completed test refunds. Customer identifier collection, private storage/writer and launcher are now prepared, independently reviewed and tested (22 checks); see `docs/customer-identity-package-2026-09-17.md`. Enabling the exact private staging schema/grants and Shopify read_customers scope plus bounded collection/replay awaits Paul's bundled approval. No live identity collection or repeat-purchase metric exists yet. Preserve separate financial fingerprints, test-order exclusion and no contact data. No current-identity conflict/deletion policy is agreed. Scheduled sync and wider remote-failure tests remain outstanding. Use parallel independent agents where useful; coordinator owns shared docs, integration and publication. Preserve existing definitions and distinguish prepared, applied and live-verified work.
