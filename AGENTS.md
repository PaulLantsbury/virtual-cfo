...
Current checkpoint: `docs/session-handover-2026-09-17.md`, `docs/roadmap-2026-09-17.md` and `docs/project-brief.md`. Paul approved Package 1 then Package 2 after the Sweet Analytics discussion. Package 2 code is implemented and staging checked; see docs/package-2-2026-09-17.md. Shopify development authentication and restricted staging intake are now applied and verified. The latest recovery package detected the second simulated refund, retained two candidate versions, preserved recheck on replay, and added a private read-only inspector; see docs/shopify-recovery-package-2026-09-17.md. Do not reapply setup or repeat the completed refund. Next proposed reporting work needs a clearly separated eligible synthetic-data route; Shopify test orders remain excluded. Scheduled sync, merchant connection UI and wider remote-failure tests remain outstanding. The 13 September handover records the previous foundation: actual shared sales/profit, approved Store D setup/read grants, blue logo accepted. Those approvals are complete; do not repeat migrations or grants. Package 1 was documentation only; Package 2 application and synthetic connector preparation are implemented; proposed financial extensions require explicit agreement. Use parallel independent agents where useful; coordinator owns shared docs, integration and publication. Preserve existing definitions and distinguish planned features from implemented or live-verified work.
