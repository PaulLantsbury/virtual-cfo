...
Paul approved preparation of **31 completed London calendar days ending yesterday**, with missed days included in the next scheduled window and older gaps/uncertain outcomes reviewed separately. This does not change tonight's deployed fixed 17 September scope. [Historical/daily preparation and limits](testing-programme-preparation-2026-09-18.md): 132 invented orders across 14 periods, refund/recovery/cost evidence, the full disposable candidate/import/review/profit SQL path and 40 browser page checks. No synthetic staging store, source transaction, new grant or generator schedule was activated. **50 focused tests passed**. Historical staging application, daily source-write API/capacity/recovery verification, consistent rolling-scope runtime propagation and exact worker deployment remain outstanding. The next genuine worker run is expected 19 September 02:00 BST; publication/readiness alone is not execution evidence.
